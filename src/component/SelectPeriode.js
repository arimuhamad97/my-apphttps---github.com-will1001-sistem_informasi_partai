...
const SelectPeriode = () => {
  ...
  return (
    <>
      ...
      <div className="top-0 left-0 bottom-0 w-screen h-[1000px] absolute  bg-transparent" style={{ visibility: Periode === false ? "hidden" : "visible", backgroundColor: "rgba(55, 65, 81, 0.32)" }}>
